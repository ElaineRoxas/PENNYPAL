...
class Application:
    def __init__(self, master):
        ...
        #=========================TITLE
        self.top_image = PhotoImage(file="Final Project in ACP & DBMS/icon/icon1.png")
        
        self.top_label = Label(self.top, image=self.top_image, bg="gray", height=100)
        self.top_label.place(x=250, y=25) 
        
        self.top_image1 = PhotoImage(file="Final Project in ACP & DBMS/icon/icon1.png")
        ...
        #========================buttons
        self.bottom_image1 = PhotoImage(file="Final Project in ACP & DBMS/icon/icon2..png")
        self.bottom_label1 = Label(self.bottom, image=self.bottom_image1, bg="light pink")
        self.bottom_label1.place(x=480, y=80) 
